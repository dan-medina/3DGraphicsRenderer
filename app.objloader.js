...
import { MTLLoader } from './app.mtlloader.js'
...
class OBJLoader {
    ...
    load( gl ) {
        ...
        let vertex_data = []
        for (let i of vertex_positions) {
            vertex_data.push(i);
        }
        for (let i of vertex_normals) {
            vertex_data.push(i);
        }
        if (material.hasTexture()) {
            ...
            for (let i of vertex_tangents) {
                vertex_data.push(i);
            }
            for (let i of vertex_texture_coords) {
                vertex_data.push(i);
            }
        }
